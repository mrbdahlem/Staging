...
- The devcontainer now builds a small custom image on top of the standard Node devcontainer base so Playwright Chromium and its Linux dependencies are preinstalled.
